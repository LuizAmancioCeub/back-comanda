...
//				.build();
		...
		return httpSecurity.cors().and().csrf().disable()
				...
				.authorizeHttpRequests(authorize -> authorize
						.requestMatchers(HttpMethod.POST, "/login/registrar").permitAll() // qlqr um pode se registrar
						.requestMatchers(HttpMethod.POST, "/login").permitAll() // qlqr um pode fazer login
						.requestMatchers(HttpMethod.POST, "/visitante/login").permitAll() // qlqr um pode fazer login
						.requestMatchers(HttpMethod.POST, "/mesa").hasAnyRole("GERENTE","CAIXA","GARCOM") // apenas Gerente
						.requestMatchers(HttpMethod.GET, "/mesas").permitAll() // lista de quem pode realizar
						.requestMatchers(HttpMethod.GET, "/mesasDisponiveis").permitAll() // lista de quem pode realizar
						...
						.requestMatchers(HttpMethod.PUT, "/cliente").hasAnyRole("CLIENTE","GERENTE")
						.requestMatchers(HttpMethod.PUT, "/gerente").hasAnyRole("GERENTE")
						.requestMatchers(HttpMethod.PUT, "/garcom").hasAnyRole("GARCOM","GERENTE")
						.requestMatchers(HttpMethod.GET, "/pedidos/gerarRelatorio").hasAnyRole("GERENTE")
//						.requestMatchers(HttpMethod.DELETE, "/flyway/clean").permitAll()
//						.requestMatchers(HttpMethod.DELETE, "/flyway/cleanAll").permitAll()
